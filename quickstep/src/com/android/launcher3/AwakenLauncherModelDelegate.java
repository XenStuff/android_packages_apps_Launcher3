...
public class AwakenLauncherModelDelegate extends QuickstepModelDelegate
    implements SmartspaceSession.OnTargetsAvailableListener {

    public static final String TAG = "AwakenLauncherModelDelegate";
    ...
    public AwakenLauncherModelDelegate(Context context) {
