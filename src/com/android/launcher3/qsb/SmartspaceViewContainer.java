...
import com.android.launcher3.AwakenLauncher;
import com.android.launcher3.AwakenLauncherModelDelegate;
...
public class SmartspaceViewContainer extends FrameLayout implements PluginListener<BcSmartspaceDataPlugin> {
    ...
    public SmartspaceViewContainer(Context context, AttributeSet attributeSet) {
        ...
        AwakenLauncher launcher = (AwakenLauncher) ActivityContext.lookupContext(context);
        launcher.getLauncherUnlockAnimationController().setSmartspaceView(mView);

        AwakenLauncherModelDelegate delegate = (AwakenLauncherModelDelegate) launcher.getModel().getModelDelegate();
    ...
    public void onPluginDisconnected(BcSmartspaceDataPlugin plugin) {
        AwakenLauncher launcher = (AwakenLauncher) ActivityContext.lookupContext(getContext());
